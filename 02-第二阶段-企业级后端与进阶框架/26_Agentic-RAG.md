...
> 本文基于参考文章「可写到简历的亮点：AgenticRAG」整理，内容侧重点有调整
...
var __INLINE_SCRIPT__ = (function () {
    ...
    if (!window.__second_open__) {
      var videoContentNoEncode = window.a_value_which_never_exists || '简历里可以把大模型自主决策的这个 Agentic RAG 流程写上去，它也是一个技术亮点\x0a\x0a具体的 Agentic RAG 流程还是要根据业务场景来设计';
      var TextContentNoEncode = window.a_value_which_never_exists || '';
      var ContentNoEncode = window.a_value_which_never_exists || '简历里可以把大模型自主决策的这个 Agentic RAG 流程写上去，它也是一个技术亮点\x0a\x0a具体的 Agentic RAG 流程还是要根据业务场景来设计';
      var itemShowType = window.a_value_which_never_exists || '5';
      var content = window.a_value_which_never_exists || '';
      var desc = window.a_value_which_never_exists || '简历里可以把大模型自主决策的这个 Agentic RAG 流程写上去，它也是一个技术亮点\x0a\x0a具体的 Agentic RAG 流程还是要根据业务场景来设计';
...
**公众号：** 神光的幸福生活 | **发布时间：** 2026-04-18 18:15:00 | **文章地址：** http://mp.weixin.qq.com/s?__biz=MzYzNzI2MTI2Nw==&mid=2247485838&idx=1&sn=fbe050dc2110e47a66bced6d35d5aabe&chksm=f1cf9ac8ffa88bb1749467ccb6d33614ca58601bc37155ab26b227451e8791b19b0be0842c35&scene=27#wechat_redirect
